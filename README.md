...
| eARC, HDMI standby through, auto standby, auto update, external control | Read/write + push          | Write verified; **not readable** over gRPC — same seeding; entities ship **disabled by default** until confirmed on your firmware |
