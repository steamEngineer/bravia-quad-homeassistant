...
| `number.bravia_quad_*_dts_dialog_control` | Number | DTS Dialog Control | 0–6 dB (GetCapabilities) | Disabled by default; gRPC-only; unavailable when the device reports the feature unavailable |
