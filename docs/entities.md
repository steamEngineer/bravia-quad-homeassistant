...
- **gRPC-only controls** — Display dimmer, HDMI CEC power-off sync, DSEE Ultimate, 360SSM height, center speaker, DTS Dialog Control, subwoofer level (with sub), dual mono, and more
