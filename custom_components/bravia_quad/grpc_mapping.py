...
GRPC_TCP_MAPPINGS: tuple[GrpcTcpMapping, ...] = (
    GrpcTcpMapping("power", FEATURE_POWER, "media_player", True),
    GrpcTcpMapping("mute", FEATURE_MUTE, "media_player", True),
    GrpcTcpMapping("volume", FEATURE_VOLUME, "media_player", True),
    GrpcTcpMapping(
