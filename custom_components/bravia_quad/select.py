"""Select platform for Bravia Quad input selection."""
...
from .const import DOMAIN, INPUT_OPTIONS, INPUT_VALUES_TO_OPTIONS
...
async def async_setup_entry(
    ...
    """Set up Bravia Quad input select from a config entry."""
    client: BraviaQuadClient = hass.data[DOMAIN][entry.entry_id]
    
    # Create entity and fetch initial state
    entity = BraviaQuadInputSelect(client, entry)
    await entity.async_update()  # Fetch current input
